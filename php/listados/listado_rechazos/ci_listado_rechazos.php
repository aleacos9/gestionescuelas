    ...
    function extender_objeto_js()
    {
        ...
        echo "
            {$id_js}.evt__notificar = function() {
                if ($('input[id*=\"82000084\"][id$=\"_seleccion\"]:checked').length == 0) {
            ...
            {$id_js}.seleccionar_todos = function() {
                $('input[id*=\"82000084\"][id$=\"_seleccion\"]:not(:disabled)').prop('checked', true).change();
            }
            {$id_js}.deseleccionar_todos = function() {
                $('input[id*=\"82000084\"][id$=\"_seleccion\"]').prop('checked', false).change();
            }
